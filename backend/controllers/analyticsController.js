...
      include: [{
        model: Product,
        as: 'product', // Already lowercase 'product', which is correct based on saleitem.js
...
      const productName = item['product.name']; // Correctly accessing aliased product name
...
    // MODIFIED: Include error stack in development environment
    res.status(500).json({ 
...
        attributes: ['purchasePrice'], // CORRECTED: Changed 'costPrice' to 'purchasePrice'
        required: true
      }],
...
      const purchasePrice = item['product.purchasePrice'] || 0; // CORRECTED: Access aliased product purchasePrice
...
        model: Product,
        as: 'product',      // Already lowercase 'product', which is correct
        attributes: ['name', 'purchasePrice'], // CORRECTED: Change 'costPrice' to 'purchasePrice'
        required: true
      }],
      raw: true, // Get raw data
    });
